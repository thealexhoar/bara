...
public class CustomBox2DRenderer implements Disposable {
    ...
    public CustomBox2DRenderer () {
        this(true, true, false, true, false, true, 1);
    }

    public CustomBox2DRenderer (boolean drawBodies, boolean drawJoints, boolean drawAABBs, boolean drawInactiveBodies,
                               boolean drawVelocities, boolean drawContacts, float lineWidth) {
    ...
    private void drawSolidCircle (Vector2 center, float radius, Vector2 axis, Color color) {
        ...
        for (int i = 0; i < 20; i++, angle += angleInc) {
            ...
            renderer.rectLine(lv.x, lv.y, v.x, v.y, lineWidth);
            lv.set(v);
        }
        renderer.rectLine(f.x, f.y, lv.x, lv.y, lineWidth);
        renderer.rectLine(center.x, center.y, center.x + axis.x * radius, center.y + axis.y * radius, lineWidth);
    }
    ...
    private void drawSolidPolygon (Vector2[] vertices, int vertexCount, Color color, boolean closed) {
        ...
        if (closed) renderer.rectLine(f.x, f.y, lv.x, lv.y, lineWidth);
    }
    ...
    private void drawSegment (Vector2 x1, Vector2 x2, Color color) {
        ...
        renderer.rectLine(x1.x, x1.y, x2.x, x2.y, lineWidth);
    }
